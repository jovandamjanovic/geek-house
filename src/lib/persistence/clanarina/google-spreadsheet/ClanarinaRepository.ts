...
import { ClanarinaRepository as DomainClanarinaRepository } from "@/lib/domain/clan-management/repository/ClanarinaRepository";
import { ClanarinaSpreadsheetConfig } from "@/lib/persistence/clanarina/google-spreadsheet/ClanarinaSpreadsheetConfig";

export class ClanarinaRepository
  extends EntityRepository<Clanarina>
  implements DomainClanarinaRepository
{
