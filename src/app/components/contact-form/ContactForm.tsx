    ...
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        <div className={styles.field}>
          ...
          />
          <span className={errors.name && dirtyFields.name ? styles.error : styles.errorPlaceholder}>
        ...
        <div className={styles.field}>
          ...
          />
          <span className={errors.email && dirtyFields.email ? styles.error : styles.errorPlaceholder}>
        ...
        <div className={styles.field}>
          ...
          />
          <span className={errors.message && dirtyFields.message ? styles.error : styles.errorPlaceholder}>
            {errors.message && dirtyFields.message ? errors.message.message : ''}
          </span>
        </div>
