        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="mb-8">
            ...
            <div className="w-32 h-32 mx-auto mb-8 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20">
              <svg
                className="w-16 h-16 text-white elixir-flask"
                fill="currentColor"
                viewBox="0 0 32 32"
              >
                {/* Elixir flask SVG */}
                <g data-name="Layer 6" id="Layer_6">
                  ...
                  <path
                    className="cls-2"
                    d="M8,8a.76.76,0,0,1-.75.75,1.51,1.51,0,0,0-1.5,1.5.75.75,0,0,1-1.5,0,1.5,1.5,0,0,0-1.5-1.5.75.75,0,0,1,0-1.5,1.5,1.5,0,0,0,1.5-1.5.75.75,0,0,1,1.5,0,1.51,1.51,0,0,0,1.5,1.5A.76.76,0,0,1,8,8Z"
                  />
                  <path
                    className="cls-2"
                    d="M30,5a.76.76,0,0,1-.75.75,1.51,1.51,0,0,0-1.5,1.5.75.75,0,0,1-1.5,0,1.5,1.5,0,0,0-1.5-1.5.75.75,0,0,1,0-1.5,1.5,1.5,0,0,0,1.5-1.5.75.75,0,0,1,1.5,0,1.51,1.51,0,0,0,1.5,1.5A.76.76,0,0,1,30,5Z"
                  />
                </g>
              </svg>
            </div>
            ...
            <p className="text-2xl md:text-3xl text-white/90 mb-8 font-light drop-shadow-lg">
              Naši alhemičari kuvaju nešto{" "}
              <span className="font-bold text-yellow-300">
                potpuno novo i uzbudljivo!
              </span>
            </p>

            <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 mb-8 border border-white/20">
              <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-6">
                U staroj laboratoriji se spremaju zabavne stvari! Naši
                alhemičari su rade naporno sa mističnim knjigama i uzbudljivim
                sastojcima kuvajući nešto samo za vas. Vidimo se ubrzo!
              </p>
            </div>
          </div>
        </div>
